...
public class println_VS_print2 {
    public static void main(String[] args) {
        ...
        System.out.println("Hello everybody, how are you all today? Today we will learn Escape Sequences, and next week we will learn Variables");

        System.out.println("----------------------------------");

        System.out.print("Hello Everyone, How are you all doing today? ");
