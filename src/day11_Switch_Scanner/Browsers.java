...
public class Browsers {
    public static void main(String[] args) {
        ...
        String result = ""; // gives a temporary value to the local variable before you use this variable you MUST initialize it.
        boolean validBrowser = browserName == "chrome" || browserName == "firefox" || browserName == "opera" || browserName == "safari" || browserName == "edge";

        if (validBrowser) { // if the pre-condition met we have 5 possibilities.
